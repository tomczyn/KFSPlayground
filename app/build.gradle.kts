...
android {
    ...
    buildTypes {
        val debug by getting {
            applicationIdSuffix = KFSPlaygroundBuildType.DEBUG.applicationIdSuffix
        }
        val release by getting {
            isMinifyEnabled = true
            applicationIdSuffix = KFSPlaygroundBuildType.RELEASE.applicationIdSuffix
            proguardFiles(
